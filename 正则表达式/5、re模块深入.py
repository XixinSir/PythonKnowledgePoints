...
print(str.split())  #不写,默认是空格
# print(str.split("   "))
print(re.split(r" +", str))  # 至少一个空格作为切割符\
...
string:目标字符串
count:最多替换次数
功能：在目标字符串中以正则表达式的规则匹配字符串,再把他们替换成指定的字符串.可以替换的次数,如果不指定,替换所有的匹配字符串
flags:
区别: 前者返回一个呗替代的字符串,后者返回一个元组,第一个元素被替换的字符串,第二个元素表示被替换的次数
"""
...
"""
str55="sunck is a good man! sunck is a nice man! sunck is a handsome man"
str56= "010-53247654"
# (?P<first>)
m = re.match(r"((?P<first>\d{3})-(?P<last>\d{8}))",str56)
